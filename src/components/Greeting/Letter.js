...
const Letter = () => {
    return (
        <div className="letter">
            ...
            <p>I hope you enjoy exploring my work as much as I've enjoyed creating it. If you have any questions or would like to discuss potential collaborations or opportunities, <a href={window.location.origin + "/about"} target="_blank" rel="noopener noreferrer">please don't hesitate to get in touch</a>
